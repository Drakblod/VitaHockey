...
def main():
    print("--- Build 3D VPK Feasibility Test Utility ---")
    godot_path = r"C:\Users\alexh\Downloads\Godot_v3.5-rc5-vita.exe"
    pck_name = "VitaHockey3DTest.pck"
    ...
    # 5. Build 3D Test VPK (VitaHockey3DTest, VTAH3D001)
    package_vpk("VitaHockey3DTest.vpk", patched_param_sfo, custom_icon)
    
    # Clean up PCK
    if os.path.exists(pck_name):
        os.remove(pck_name)
    print("Done! VitaHockey3DTest.vpk is ready in the root folder.")
